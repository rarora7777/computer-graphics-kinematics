...
there's a rigid transformation <img src="svgs/e4e894fddf2f412a176bb46f93357104.svg?invert_in_darkmode&sanitize=true" align=middle width=143.469975pt height=32.14629pt/> that places its tail and tip to the desired positions in the model. 
...
<p align="center"><img src="svgs/262a646f8f71f6da6df6b11cb097c5b8.svg?invert_in_darkmode&sanitize=true" align=middle width=261.2841pt height=138.08355pt/></p>
...
<p align="center"><img src="svgs/711d3a65a6ac9e3860ad5c2900f7859c.svg?invert_in_darkmode&sanitize=true" align=middle width=226.0038pt height=138.08355pt/></p>
...
In general, each rest bone undergoes a rigid transformation <img src="svgs/e89070fea1f23ca7baf9956bd9680795.svg?invert_in_darkmode&sanitize=true" align=middle width=70.79886pt height=26.76201pt/>,
...
<img src="svgs/02f380174e367c8935a57f86907fc7da.svg?invert_in_darkmode&sanitize=true" align=middle width=13.150665pt height=22.55715pt/> is expressed as a _global_ mapping of any point in the rest reference frame
...
values for <img src="svgs/02f380174e367c8935a57f86907fc7da.svg?invert_in_darkmode&sanitize=true" align=middle width=13.150665pt height=22.55715pt/>. In particular, we would like each bone to rotate about its
parent's tip, but this position is determined by the parent's pose
transformation <img src="svgs/9edc4d158664ffc245acb3d645a207af.svg?invert_in_darkmode&sanitize=true" align=middle width=19.927215pt height=22.55715pt/>, which in turn should rotate about the grandparent's tip
and so on.
...
<p align="center"><img src="svgs/3df3731615202d3883213af8f7c72d8d.svg?invert_in_darkmode&sanitize=true" align=middle width=402.50265pt height=157.809795pt/></p>

> **Question:** Does using relative rotations ensure that bone tails stay
> coincident with parent tips?
>
> **Hint:** What do you get if you multiply <img src="svgs/e36717016e5278d19538bb9a5f500387.svg?invert_in_darkmode&sanitize=true" align=middle width=17.80152pt height=22.55715pt/> and <img src="svgs/06751f0b0b6caaa7955275b01f167bb2.svg?invert_in_darkmode&sanitize=true" align=middle width=12.945405pt height=24.20121pt/>?
...
(shinbone)](https://en.wikipedia.org/wiki/Tibia) and <img src="svgs/e468ef4a9a101ead715ed84a6b9bcc0b.svg?invert_in_darkmode&sanitize=true" align=middle width=18.828975pt height=22.55715pt/> applies a bend at
...
<p align="center"><img src="svgs/eb643559bc7323d528e9724bced84216.svg?invert_in_darkmode&sanitize=true" align=middle width=558.62235pt height=157.809795pt/></p>
...
> **Question:** What abstract data-structure is good for ensuring a parent's transformation  <img src="svgs/62608795c18f3bd5ce9c26bce0e210e4.svg?invert_in_darkmode&sanitize=true" align=middle width=24.31275pt height=22.55715pt/>
> are computed before its child's <img src="svgs/e36717016e5278d19538bb9a5f500387.svg?invert_in_darkmode&sanitize=true" align=middle width=17.80152pt height=22.55715pt/>?
>
> **Hint:** 🥞
...
<img src="svgs/fe95fd1126bb6ed125fbbe619d694d02.svg?invert_in_darkmode&sanitize=true" align=middle width=23.173755pt height=22.63866pt/> and then "un"-twisting by <img src="svgs/01077064f9efeed9db887638325020d3.svg?invert_in_darkmode&sanitize=true" align=middle width=35.95911pt height=22.63866pt/> after bending.
...
<img src="svgs/e4ad6bc27b560b37ad836731988bf416.svg?invert_in_darkmode&sanitize=true" align=middle width=57.401685pt height=26.76201pt/> (often the "tip" of a
...
tip <img src="svgs/c6fb89b60f91828eac09b587b990ddae.svg?invert_in_darkmode&sanitize=true" align=middle width=15.757995pt height=14.61207pt/> of some bone <img src="svgs/4bdc8d9bcfb35e1c9bfb51fc69687dfc.svg?invert_in_darkmode&sanitize=true" align=middle width=7.0548555pt height=22.83138pt/> and a desired goal location <img src="svgs/30d5d562f63636be72c19af8ec405255.svg?invert_in_darkmode&sanitize=true" align=middle width=50.79888pt height=26.76201pt/>:

<p align="center"><img src="svgs/38405dbde6e9d02d7ab8166b7db62c9b.svg?invert_in_darkmode&sanitize=true" align=middle width=139.39233pt height=18.31236pt/></p>
...
<p align="center"><img src="svgs/8bc7d7faa47a4aa1b24e33c06e3f524d.svg?invert_in_darkmode&sanitize=true" align=middle width=183.3414pt height=18.31236pt/></p>
...
So, over all choices of <img src="svgs/41f28962986ecdd9c1dc2af8b83fef84.svg?invert_in_darkmode&sanitize=true" align=middle width=9.18951pt height=14.61207pt/> we'd like to optimize:

<p align="center"><img src="svgs/1daf19d464ed6d3feac47efc092705f0.svg?invert_in_darkmode&sanitize=true" align=middle width=190.0173pt height=44.969925pt/></p>
...
Second, for all of the other end effectors <img src="svgs/1d0d9bd3ae0a6e8e2a4040fd35030b3b.svg?invert_in_darkmode&sanitize=true" align=middle width=59.837085pt height=24.6576pt/>, we will
...
choices of <img src="svgs/41f28962986ecdd9c1dc2af8b83fef84.svg?invert_in_darkmode&sanitize=true" align=middle width=9.18951pt height=14.61207pt/>:
...
a function of <img src="svgs/41f28962986ecdd9c1dc2af8b83fef84.svg?invert_in_darkmode&sanitize=true" align=middle width=9.18951pt height=14.61207pt/> we must solve a [non-linear least
...
<p align="center"><img src="svgs/f354fcbf8db9e5a69bc921096f2ace93.svg?invert_in_darkmode&sanitize=true" align=middle width=231.0594pt height=43.251615pt/></p>
...
The change in tip positions <img src="svgs/b0ea07dc5c00127344a1cad40467b8de.svg?invert_in_darkmode&sanitize=true" align=middle width=9.97722pt height=14.61207pt/> with respect to joint angles <img src="svgs/41f28962986ecdd9c1dc2af8b83fef84.svg?invert_in_darkmode&sanitize=true" align=middle width=9.18951pt height=14.61207pt/> does not
...
<p align="center"><img src="svgs/10d622f11190c4bc164f8e4aa28fb4ca.svg?invert_in_darkmode&sanitize=true" align=middle width=58.73373pt height=33.81213pt/></p>

Written in terms of <img src="svgs/4b89c22bc825ade97f0e007ade8f761b.svg?invert_in_darkmode&sanitize=true" align=middle width=9.77163pt height=22.55715pt/> our step becomes,

<p align="center"><img src="svgs/488a9a40a4f71b24e857be2ad27f45ee.svg?invert_in_darkmode&sanitize=true" align=middle width=168.2538pt height=39.45249pt/></p>

> **Question:** Can we take an arbitrarily large step <img src="svgs/e38aac0b1f52dfdadca9fba9bcfa5b95.svg?invert_in_darkmode&sanitize=true" align=middle width=52.90527pt height=21.18732pt/>?
>
> **Hint:** What if we just need to change <img src="svgs/41f28962986ecdd9c1dc2af8b83fef84.svg?invert_in_darkmode&sanitize=true" align=middle width=9.18951pt height=14.61207pt/> by a small, non-zero amount?
...
<p align="center"><img src="svgs/6a07539d71381c6f93fa61e1190ad4c2.svg?invert_in_darkmode&sanitize=true" align=middle width=216.3909pt height=18.636585pt/></p>

We'll refer to this as a projection filter acting on the entire vector <img src="svgs/41f28962986ecdd9c1dc2af8b83fef84.svg?invert_in_darkmode&sanitize=true" align=middle width=9.18951pt height=14.61207pt/>:
...
> direction. The choice of <img src="svgs/7aed918aa12a276a602e30e90b0b109d.svg?invert_in_darkmode&sanitize=true" align=middle width=9.982995pt height=14.15535pt/> reflects how much we "trust" this direction.
> Unfortunately, if <img src="svgs/7aed918aa12a276a602e30e90b0b109d.svg?invert_in_darkmode&sanitize=true" align=middle width=9.982995pt height=14.15535pt/> is too large our iterations may diverge. If <img src="svgs/7aed918aa12a276a602e30e90b0b109d.svg?invert_in_darkmode&sanitize=true" align=middle width=9.982995pt height=14.15535pt/> is too
...
> 
> Given an initial guess <img src="svgs/83dbb4b45296124797c845dc3b48fa63.svg?invert_in_darkmode&sanitize=true" align=middle width=16.5297pt height=26.76201pt/> we're looking to find a change <img src="svgs/52cdbba1eb4fddc47169867a1330fa0d.svg?invert_in_darkmode&sanitize=true" align=middle width=23.67585pt height=22.46574pt/> so that <img src="svgs/0eaaed4bba880174a78a00910749ac23.svg?invert_in_darkmode&sanitize=true" align=middle width=101.59809pt height=26.76201pt/> is a stationary point.
> 
> Starting with our equilibrium equation,
> <p align="center"><img src="svgs/d2662ad457e2e9d04a48fd0f18b32d60.svg?invert_in_darkmode&sanitize=true" align=middle width=114.41859pt height=34.725405pt/></p>
> 
...
> expansion
> 
> <p align="center"><img src="svgs/056f19f2520a45baf7908599494fafdd.svg?invert_in_darkmode&sanitize=true" align=middle width=541.34355pt height=35.777445pt/></p>
> 
...
> Solving for the change <img src="svgs/3919bbc84b8079e27194efe99a1f6a80.svg?invert_in_darkmode&sanitize=true" align=middle width=23.09373pt height=22.46574pt/> we get:
...
> 
> <p align="center"><img src="svgs/90a130f831709bf3feb431b84a94c121.svg?invert_in_darkmode&sanitize=true" align=middle width=243.5004pt height=35.777445pt/></p>
> 
> If our Taylor series approximation was perfect (no high order terms in <img src="svgs/e378afcd7cae11e7306c61a9c35bf6cf.svg?invert_in_darkmode&sanitize=true" align=middle width=19.178115pt height=14.15535pt/>; in
...
>  2. <img src="svgs/930b956ef51654e0669455a2cdd62fb5.svg?invert_in_darkmode&sanitize=true" align=middle width=14.79456pt height=22.55715pt/> is often difficult or expensive to compute.
>  4. <img src="svgs/930b956ef51654e0669455a2cdd62fb5.svg?invert_in_darkmode&sanitize=true" align=middle width=14.79456pt height=22.55715pt/> may be singular.
>  3. Inverting <img src="svgs/930b956ef51654e0669455a2cdd62fb5.svg?invert_in_darkmode&sanitize=true" align=middle width=14.79456pt height=22.55715pt/> (even if possible) is often slow.
...
> these issues by considering various approximations of the Hessian matrix <img src="svgs/930b956ef51654e0669455a2cdd62fb5.svg?invert_in_darkmode&sanitize=true" align=middle width=14.79456pt height=22.55715pt/>.
> We'll never actually compute <img src="svgs/930b956ef51654e0669455a2cdd62fb5.svg?invert_in_darkmode&sanitize=true" align=middle width=14.79456pt height=22.55715pt/>.
> 
> #### Gradient Descent _Revisited_
> 
> The simplest approximation of <img src="svgs/930b956ef51654e0669455a2cdd62fb5.svg?invert_in_darkmode&sanitize=true" align=middle width=14.79456pt height=22.55715pt/> is the identity matrix <img src="svgs/d8471e559d932f20f66bec32f6002e08.svg?invert_in_darkmode&sanitize=true" align=middle width=7.168986pt height=22.55715pt/>. Plugging this
...
> 
> <p align="center"><img src="svgs/9419e96ede420bf144ab3a0f38405db7.svg?invert_in_darkmode&sanitize=true" align=middle width=204.3723pt height=35.777445pt/></p>
> 
> #### Gauss-Newton
>
> Given that we have already computed first derivatives in the Jacobian <img src="svgs/92b02b175485ba3cf5d2e5ad2b4568fe.svg?invert_in_darkmode&sanitize=true" align=middle width=78.66375pt height=33.20559pt/>, an even better approximation for Hessian <img src="svgs/930b956ef51654e0669455a2cdd62fb5.svg?invert_in_darkmode&sanitize=true" align=middle width=14.79456pt height=22.55715pt/> than the
> identity <img src="svgs/d8471e559d932f20f66bec32f6002e08.svg?invert_in_darkmode&sanitize=true" align=middle width=7.168986pt height=22.55715pt/> would be to use <img src="svgs/e71c2eb0164135302652c3b5e3ca430a.svg?invert_in_darkmode&sanitize=true" align=middle width=29.6406pt height=27.91272pt/>. The resulting update becomes:
>
> <p align="center"><img src="svgs/8ba397bd9812841129ba3231d287f6a8.svg?invert_in_darkmode&sanitize=true" align=middle width=241.2927pt height=34.725405pt/></p>
>
> Unlike <img src="svgs/930b956ef51654e0669455a2cdd62fb5.svg?invert_in_darkmode&sanitize=true" align=middle width=14.79456pt height=22.55715pt/>, <img src="svgs/b166bfa6fb8405dcd97b1c618c8fc258.svg?invert_in_darkmode&sanitize=true" align=middle width=28.715775pt height=27.91272pt/> is easy to compute if we're already computing
> <img src="svgs/4b89c22bc825ade97f0e007ade8f761b.svg?invert_in_darkmode&sanitize=true" align=middle width=9.77163pt height=22.55715pt/>. It is guaranteed to be [positive
...
> <img src="svgs/b166bfa6fb8405dcd97b1c618c8fc258.svg?invert_in_darkmode&sanitize=true" align=middle width=28.715775pt height=27.91272pt/> starts misbehaving.
>
> A good fix is to blend between the gradient descent and Gauss-Newton search
> directions. That is blend between <img src="svgs/d8471e559d932f20f66bec32f6002e08.svg?invert_in_darkmode&sanitize=true" align=middle width=7.168986pt height=22.55715pt/> and <img src="svgs/b166bfa6fb8405dcd97b1c618c8fc258.svg?invert_in_darkmode&sanitize=true" align=middle width=28.715775pt height=27.91272pt/>. This is called
> the [Levenberg-Marquadt
> algorithm](https://en.wikipedia.org/wiki/Levenberg–Marquardt_algorithm).

#### Finite Differencing

But how do we compute the kinematic Jacobian <img src="svgs/4b89c22bc825ade97f0e007ade8f761b.svg?invert_in_darkmode&sanitize=true" align=middle width=9.77163pt height=22.55715pt/>? Since each entry in <img src="svgs/b0ea07dc5c00127344a1cad40467b8de.svg?invert_in_darkmode&sanitize=true" align=middle width=9.97722pt height=14.61207pt/> is
...
function (each with a slightly different input), which is in turn <img src="svgs/5e12273846712182a9633dc4c62b94f7.svg?invert_in_darkmode&sanitize=true" align=middle width=40.213965pt height=24.6576pt/>. This
makes the total cost <img src="svgs/d9fad1122d3ed3c58f6d9342c9260180.svg?invert_in_darkmode&sanitize=true" align=middle width=47.588475pt height=26.76201pt/> to fill in our <img src="svgs/4b89c22bc825ade97f0e007ade8f761b.svg?invert_in_darkmode&sanitize=true" align=middle width=9.77163pt height=22.55715pt/> matrix.


>
> #### Automatic Differentiation
>
> Forward differencing requires <img src="svgs/5e12273846712182a9633dc4c62b94f7.svg?invert_in_darkmode&sanitize=true" align=middle width=40.213965pt height=24.6576pt/> evaluations but doesn't require us to
...
> compute <img src="svgs/4b89c22bc825ade97f0e007ade8f761b.svg?invert_in_darkmode&sanitize=true" align=middle width=9.77163pt height=22.55715pt/>.
>
...
> construct <img src="svgs/4b89c22bc825ade97f0e007ade8f761b.svg?invert_in_darkmode&sanitize=true" align=middle width=9.77163pt height=22.55715pt/> is again <img src="svgs/d9fad1122d3ed3c58f6d9342c9260180.svg?invert_in_darkmode&sanitize=true" align=middle width=47.588475pt height=26.76201pt/>.
>
...
> to all variables <img src="svgs/41f28962986ecdd9c1dc2af8b83fef84.svg?invert_in_darkmode&sanitize=true" align=middle width=9.18951pt height=14.61207pt/> in a single _backwards_ evaluation. The total cost is
> only <img src="svgs/5e12273846712182a9633dc4c62b94f7.svg?invert_in_darkmode&sanitize=true" align=middle width=40.213965pt height=24.6576pt/> to fill <img src="svgs/4b89c22bc825ade97f0e007ade8f761b.svg?invert_in_darkmode&sanitize=true" align=middle width=9.77163pt height=22.55715pt/>. 
>
...
a _ray_) and we'd like to find a positive amount <img src="svgs/7aed918aa12a276a602e30e90b0b109d.svg?invert_in_darkmode&sanitize=true" align=middle width=9.982995pt height=14.15535pt/> to move along this line that actually
does decrease the energy:

<p align="center"><img src="svgs/1ca721bb236bc9eac6f1c5ec58939490.svg?invert_in_darkmode&sanitize=true" align=middle width=192.07155pt height=16.438356pt/></p>

While there exists an optimal step <img src="svgs/7aed918aa12a276a602e30e90b0b109d.svg?invert_in_darkmode&sanitize=true" align=middle width=9.982995pt height=14.15535pt/>, we don't want to spend too long finding
it as we would be better off spending our computational efforts improving the
descent _direction_ for the next step. So, starting with a large value <img src="svgs/7aed918aa12a276a602e30e90b0b109d.svg?invert_in_darkmode&sanitize=true" align=middle width=9.982995pt height=14.15535pt/>
(e.g., 10,000), we decrease <img src="svgs/7aed918aa12a276a602e30e90b0b109d.svg?invert_in_darkmode&sanitize=true" align=middle width=9.982995pt height=14.15535pt/> by a constant factor (e.g., <img src="svgs/2eacd907c22e9ad1db070a00eef0f2cd.svg?invert_in_darkmode&sanitize=true" align=middle width=6.552645pt height=27.77577pt/>) until our
inequality passes.
...
(i.e., <img src="svgs/49b56b61879620cabceffb019733f6f5.svg?invert_in_darkmode&sanitize=true" align=middle width=43.21911pt height=22.46574pt/>, but <img src="svgs/445f6c51de634201dfa36e3e70c305ce.svg?invert_in_darkmode&sanitize=true" align=middle width=77.739585pt height=24.6576pt/>). In our assignment, a thin line will appear if
...
average or linear combination of each bone's pose transformation <img src="svgs/cf88dd7d2caab71d7d04c50df09687a9.svg?invert_in_darkmode&sanitize=true" align=middle width=19.25517pt height=22.55715pt/> applied
...
> **Question:** What transformation matrix do you get if you compute: <img src="svgs/756285da3ecfc8e56dc7f53510fc54ff.svg?invert_in_darkmode&sanitize=true" align=middle width=170.36943pt height=27.77577pt/>?
>
