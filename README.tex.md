...
there's a rigid transformation $\widehat{\mathbf{T}} = (\widehat{\Rot} \quad \widehat{\mathbf{t}} ) \in 
...
\widehat{\Rot} \left(\begin{array}{c}0\\\\mathbf{0}\\\\mathbf{0}\end{array}\right) + \widehat{\mathbf{t}} 1 = \widehat{\mathbf{t}}.
$$
...
\widehat{\Rot}\left(\begin{array}{c}\ell\\\\mathbf{0}\\\\mathbf{0}\end{array}\right) + \widehat{\mathbf{t}}.
$$
...
composed of a rotation $\Rot \in  \mathbf{R}^{3\times 3}$ and a translation $\mathbf{t}\in \mathbf{R}^{3}$, mapping each of its 
...
bone $i$ in a skeleton is to aggregate _relative rotations_ $\overline{\Rot}_i \in 
...
\left(\begin{array}{cccc} \overline{\Rot}_i      & \begin{array}{c}0\\\\mathbf{0}\\\\mathbf{0}\\\\\end{array} \\\\ 0\ 0\ 0 & 1\end{array}\right)
...
rotations (three [Euler angles][eulerangles], $Theta _1 ,	heta _2 ,	heta _3 $). Each bone's rotation
...
\mathbf{T}_{p_i} 
\widehat{\mathbf{T}}_i
\left(\begin{array}{cccc} \Rot_x(	heta _{i3})      & \begin{array}{c}0\\\\mathbf{0}\\\\mathbf{0}\\\\\end{array} \\\\ 0\ 0\ 0 & 1\end{array}\right)
\left(\begin{array}{cccc} \Rot_z(	heta _{i2})      & \begin{array}{c}0\\\\mathbf{0}\\\\mathbf{0}\\\\\end{array} \\\\ 0\ 0\ 0 & 1\end{array}\right)
\left(\begin{array}{cccc} \Rot_x(	heta _{i1})      & \begin{array}{c}0\\\\mathbf{0}\\\\mathbf{0}\\\\\end{array} \\\\ 0\ 0\ 0 & 1\end{array}\right)
\left.\widehat{\mathbf{T}}_i\right.^{-1}
$$
where the matrix $\Rot_w(\varphi ) \in  \mathbf{R}^{3\times 3}$ is the rotation by $\varphi $ degrees around
the $w$-axis.
...
> **Question:** What transformation matrix do you get if you compute: $\frac12  \Rot_x(90^\circ ) + \frac12  \Rot_x(-90^\circ )$?
>
> **Hint:** It's not $\Rot_x(0^\circ )$.
